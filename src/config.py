...
def set_configuration():
    ...
    parser = argparse.ArgumentParser(description="All parameters related to policy and optimization.")

    parser.add_argument("-d", "--divisions", type=int, default=20)
    ...
    parser.add_argument("-pgm", "--policy-gradient-method", choices=["ppo", "reinforce"], default="reinforce")
    ...
    config.time_points = [config.ti + div * config.subinterval for div in range(config.divisions)]
